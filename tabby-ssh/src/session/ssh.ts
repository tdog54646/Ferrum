    ...
    async start (): Promise<void> {
        ...
        this.ssh.x11ChannelOpen$.subscribe(async event => {
            ...
            try {
                ...
                this.emitServiceMessage(`    Ferrum tried to connect to ${JSON.stringify(X11Socket.resolveDisplaySpec(displaySpec))} based on the DISPLAY environment var (${displaySpec})`)
